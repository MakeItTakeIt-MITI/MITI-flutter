...
class UserDeleteSuccessScreen extends StatefulWidget {
  static String get routeName => 'deleteSuccessUser';
  final int bottomIdx;

  const UserDeleteSuccessScreen({super.key, required this.bottomIdx});

  @override
  State<UserDeleteSuccessScreen> createState() =>
      _UserDeleteSuccessScreenState();
}

class _UserDeleteSuccessScreenState extends State<UserDeleteSuccessScreen> {
