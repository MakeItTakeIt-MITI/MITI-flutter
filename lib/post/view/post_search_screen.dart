  ...
  void search(String text) {
    ...
    ref
        .read(postPaginationProvider(true,
                cursorParam: const CursorPaginationParam())
            .notifier)
        .updateDebounce(param: PostSearchParam(search: text));
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: NestedScrollView(
            ...
            body: _getBody(isSearching, categories, searchForm)),
      ),
    );
  }
              ...
              SliverToBoxAdapter(
                child: Consumer(
                  builder:
                    ...
                    final model = (result
                            as ResponseListModel<PopularSearchWordListResponse>)
                        .data!;
                    ...
                    return SearchChipComponent(
                      ...
                      contents: contents,
                      onSelect: (int index) {
                        textEditingController.text = model[index].searchWord;
                        search(model[index].searchWord);
                        // ref
                        //     .read(postSearchProvider(true).notifier)
          ...
          slivers: [
            Consumer(
              builder: (BuildContext context, WidgetRef ref, Widget? child) {
                ...
                final cp = state
                    as ResponseModel<CursorPaginationModel<BasePostResponse>>;
