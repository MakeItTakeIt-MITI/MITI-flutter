...
@riverpod
Future<BaseModel> login(Ref ref,
  ...
  return await ref
    ...
    await saveUserInfo(storage, model, providerRef: ref);
    return value;
  }).catchError((e) {
...
Future<void> saveUserInfo(
  ...
  assert(widgetRef != null || providerRef != null,
      'Either widgetRef or providerRef must be provided');
  ...
  if (widgetRef != null) {
    await widgetRef.read(authProvider.notifier).autoLogin();
  } else {
    await providerRef!.read(authProvider.notifier).autoLogin();
  }
}
